...
namespace AG.Domain.Concretes
{
    public class TweetFeedGenerator : IFeedGenerator
    {
        ...
        public List<string> SimulateFeed(string UserFilePath, string TweetFilePath)
        {
            ...
            try
            {
                ...
                foreach (var userKey in usersList)
                {
                    ...
                    foreach (var orderedTweet in orderedTweetList.OrderBy(x => x))
                    {
                        ...
                        feedList.Add(CreateTweetFeed(tweetUser, userTWeet));
                    }
                }
            ...
            catch (Exception e)
            {
                ...
                logger.TryLog($"Exceptiong thrown : {e.ToString()}");
                feedList.Add($"Exceptiong thrown : {e.ToString()}");
            }
            return feedList;
        }
        ...
        private string CreateTweetFeed(string user, string tweet)
        {
